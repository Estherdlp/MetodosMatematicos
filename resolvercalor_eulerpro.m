...
##
## Integra la ecuacion del calor 1D homogenea mediante diferencias finitas aplicando el metodo de Euler progresivo (en tiempo).
##
## * Entrada *
##
## @var{a}, escalar. Coeficiente de difusividad termica.
##
## @var{g}, funcion. Termino fuente. Debe aceptar dos entradas, una de espacio, @code{x}, y otra de tiempo, @code{t}, o una unica entrada de espacio.
##
## @var{f}, funcion. Condicion inicial. Debe aceptar una entrada de espacio, @code{x}.
##
## @var{rangoxt}, vector. Rangos de integracion en espacio y tiempo, @code{[x_ini x_fin t_ini t_fin]}.
##
## @var{N}, vector. Numeros de divisiones de los intervalos de integracion, @code{[Nx Nt]}.
##
## * Salida *
##
...
##
## @var{u}, matriz. Solucion en los nodos.
##
## @end deftypefn
function [x,t,u]=resolvercalor_eulerpro(a,funf,rangoxt,N)
